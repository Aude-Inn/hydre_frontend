...
export function GameLists() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start rounded-3xl  text-white px-4 py-10">
      <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-purple-300 to-teal-300 animate-fade-in">
        Game List :
      </h1>
